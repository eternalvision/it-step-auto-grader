// ==UserScript==
// @name         IT Step Auto Grader
// @namespace    https://github.com/eternalvision/it-step-auto-grader
// @version      1.0.0
// @description  Sequential IT Step homework grading helper
// @match        https://itstep.org/*
// @match        https://*.itstep.org/*
...
(() => {
  ...
  const INIT_FLAG = Symbol.for("it-step-auto-grader.tampermonkey.initialized");
  if (window[INIT_FLAG]) {
    console.debug("IT Step Auto Grader уже инициализирован; повторный запуск пропущен");
    return;
  }
